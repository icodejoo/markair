...
> **状态**:任务已拆解到文件级,**尚未开工**。本文档是 [04-delivery-plan.md](04-delivery-plan.md) 中 M1 阶段的细化,**不引入任何新的范围决策** —— 做什么 / 不做什么全部沿用 04 与 [01-requirements.md §6 / §8](01-requirements.md#6-gfm-支持范围-已裁决-2026-09-16全节定稿) 已裁决的结论。
>
